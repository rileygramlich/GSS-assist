...
export const TIERS = [
  ...
  {
    /* Sits above the voice product's Pro tier at $549 rather than level with
       it. At the same price a bundle containing everything Pro has plus a
       second channel would make Pro unsellable, which is a strange thing to do
       to the tier most people buy. Full pitch lives on /both. */
    name: "Both lines",
    price: 699,
    ...
    features: [
      ...
      "Missed-call text-back across the two",
